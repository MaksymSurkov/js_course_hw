...
if (confirm('Почати тестування?')) {
	...
	for (let i = 1; i <= userShells; i++) {
		...
		// Здесь сделано так, что если выстрел будет на растоянии 1 клеточки по периметру всего коробля (включая диагональные клеточки), 
		// то будет уведомление-подсказка якобы корабль ранен.
